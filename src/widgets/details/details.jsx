...
export default function Details() {
  ...
  if (tempData && Object.keys(tempData).length > 0){
    console.log(tempData)
    return (
    <div className="h-[87vh] w-1/5 items-center shadow-xl bg-white rounded-lg px-4 pb-4 overflow-y-auto">
  ...
  return (
    <div className="h-[87vh] w-1/4 items-center shadow-xl bg-white rounded-lg px-4 pb-4 overflow-y-auto">
      <h1 className="text-center text-3xl text-semibold py-4">Details</h1>
      {data.map((item, index) => (
